        ...
        <header className={`${AppHeaderStyle.header}`}>
            <div className={`${AppHeaderStyle.wrapper}`}>
                ...
                <NavLink to='/orders' className={`${AppHeaderStyle.link}`} activeClassName={AppHeaderStyle.linkActive}>
                    ...
                    <span className={`${pathname === '/' ? 'text_color_active' : 'text_color_inactive'} text text_type_main-default  ${AppHeaderStyle.linkText}`}>Лента заказов</span>
                </NavLink>
                ...
                <NavLink to='/profile' className={`${AppHeaderStyle.link}`} activeClassName={AppHeaderStyle.linkActive}>
                    ...
                    <span className={`${pathname.includes('/profile') === '/profile' ? 'text_color_active' : 'text_color_inactive'} text text_type_main-default ${AppHeaderStyle.linkText}`}>Личный кабинет</span>
                </NavLink>
            </div>
